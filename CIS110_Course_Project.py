...
story("After typing your answer, be sure to press the enter key.\n")
...
#Story Intro
story("Our story begins here in a lush garden as dusk begins to set. Sunlight barely peeking from the western horizon.")
